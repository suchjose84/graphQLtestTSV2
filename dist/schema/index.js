        ...
        itemById: {
            ...
            async resolve(parent, args) {
                try {
                    ...
                    if (!item) {
                        throw new graphql_1.GraphQLError('Item not found', null, null, null, null, null, {
                            statusCode: '404'
                        });
                    }
        ...
        searchItems: {
            ...
            resolve(parent, args) {
                ...
                return Inventory.find(query)
                    ...
                    .catch((error) => {
                    throw new graphql_1.GraphQLError(`Error retrieving items: ${error.message}`, null, null, null, [
                        error
                    ]);
                });
            }
